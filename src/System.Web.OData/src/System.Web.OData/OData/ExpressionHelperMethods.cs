...
namespace System.Web.OData
{
    internal class ExpressionHelperMethods
    {
        ...
        private static MethodInfo _filteredCountMethod = GenericMethodOf(_ => Queryable.Where<int>(default(IQueryable<int>), default(Expression<Func<int, bool>>)).Count());
        ...
        public static MethodInfo QueryAbleFilteredCountGeneric
        {
            get { return _filteredCountMethod; }
        }
