...
namespace Microsoft.OData {
    ...
    internal static class Strings {
        ...
        /// A string like "'with' expected at position {0} in '{1}'."
        /// </summary>
        internal static string UriQueryExpressionParser_EqualExpected(object p0, object p1)
        {
            return Microsoft.OData.TextRes.GetString(Microsoft.OData.TextRes.UriQueryExpressionParser_EqualExpected, p0, p1);
        }
