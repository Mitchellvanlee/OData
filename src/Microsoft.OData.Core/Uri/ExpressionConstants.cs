...
namespace Microsoft.OData
{
    ...
    internal static class ExpressionConstants
    {
        ...
        /// <summary> the filteredcount query option.</summary>
        internal const string QueryOptionFilteredCount = "$filteredcount";
        ...
        /// <summary>"count" keyword for expressions.</summary>
        internal const string KeywordCount = "count";

        /// <summary>"filteredcount" keyword for expressions.</summary>
        internal const string KeywordFilteredCount = "filteredcount";
