...
namespace Microsoft.OData.UriParser
{
    ...
    public enum QueryNodeKind
    {
        ...
        /// </summary>
        FilteredCount = InternalQueryNodeKind.FilteredCount,
    }
    ...
    internal enum InternalQueryNodeKind
    {
        ...
        /// <summary>
        /// Node describing filteredcount of a collection contains primitive or enum or complex or entity type, with a filter.
        /// </summary>
        FilteredCount = 30,
    }
}